...
DROP POLICY IF EXISTS "Allow anyone to read results" ON public.profile_results;
DROP POLICY IF EXISTS "Allow anyone to insert results" ON public.profile_results;
